from . import AnyPrecisionLinear

from transformers import AutoConfig
from .BaseAPForCausalLM import BaseAPForCausalLM
from .AutoAPForCausalLM import AutoAPForCausalLM
import logging
import yaml
import os
    ...
    def from_quantized(
        ...
        if config.anyprec_model_type == "auto":
            ...
            try:
                ...
                with open(os.path.join(dirpath, f'../models/{config.anyprec_model_type}.yaml')) as f:
